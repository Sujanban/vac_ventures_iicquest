...
<body class="hold-transition sidebar-mini">
      ...
      <div class="content">
        ...
        <div class="card">
          <div class="cart-box" id="cartBox">
            <img src="../../front/assets/jumpingjack.gif" alt="" />
          ...
          <div class="message" id="message">
            ...
            <div class="flex items-center space-x-2 justify-center">
              ...
              <p class="py-4 text-sm font-semibold leading-6 text-indigo-600">
                <a href="./exercise.php" class="px-3 py-2 bg-blue-600 rounded text-white">Play agian</a>
              </p>
            </div>
          </div>
        </div>
  ...
  <script>
      document.addEventListener("DOMContentLoaded", function () {
        ...
        let timeLeft = 120; // 60 seconds for the countdown
