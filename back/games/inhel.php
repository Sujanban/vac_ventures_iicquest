    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Inhale Exhale Meditation</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">Inhale Exhale</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      ...
      <div class="content">
        ...
        <div class="card">
          <div class="cart-box" id="cartBox">
            <img src="../../front/assets/inhaleexhale.gif" alt="">
          ...
          <div class="message" id="message">
            ...
            <div class="flex items-center space-x-2 justify-center">
              <p class="py-4 text-sm font-semibold leading-6 text-indigo-600">
                <a href="../dashboard/dashboard.php" class="px-3 py-2 bg-blue-600 rounded text-white">Return to Dashboard</a>
              </p>
              <p class="py-4 text-sm font-semibold leading-6 text-indigo-600">
                <a href="./inhel.php" class="px-3 py-2 bg-blue-600 rounded text-white">Play agian</a>
              </p>
            </div>
          </div>
        </div>
