...
$userdata = $_SESSION["sessionuser"];

$select = " SELECT * FROM data WHERE Code='$userdata' ";
...
?>
            <tr>
                ...
                <td><?php echo $select_data['Data']; ?></td>
                <td>
                    <a href="../../front/report.php?id=<?php echo $select_data['UID']; ?>" class="btn btn-sm btn-primary">View Report</a>
                </td>
            </tr>
<?php } ?>
        </tbody>
